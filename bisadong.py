...
def speak_text(text_to_speak, speech_key, speech_region):
    """Mengubah teks menjadi suara menggunakan Azure Speech SDK."""
    try:
...
# Fungsi GPS telah dihapus dari kode. Aktifkan kembali secara terpisah jika diperlukan.
# def get_location_from_gpsd():
#     ...

def get_location_from_ip():
    """Mendapatkan lokasi dari IP Geolocation."""
...
def get_best_available_location():
    """Menggunakan IP Geolocation sebagai sumber lokasi."""
    print("\nMenggunakan IP Geolocation sebagai sumber lokasi utama.")
    location = get_location_from_ip()
    return location

def get_routable_location(lat_lon_str, maps_key):
    """Mencari jalan terdekat untuk koordinat agar bisa dirutekan."""
    ...
    try:
        ...
        print("Gagal menemukan jalan terdekat.")
        return None

def cari_poi_dengan_nama(nama_tempat, maps_key, lat_konteks, lon_konteks):
    """Mencari POI (Point of Interest) berdasarkan nama."""
